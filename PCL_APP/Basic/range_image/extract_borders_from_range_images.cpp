...
#include <pcl/visualization/range_image_visualizer.h>//范围图像 可视化
#include <pcl/visualization/pcl_visualizer.h>//可视化
#include <pcl/features/range_image_border_extractor.h>//范围图像 特整提取
#include <pcl/console/parse.h>// 命令行参数
...
// =======参数设置 Parameters=================================
// --------------------
float angular_resolution = 0.5f;//范围图像 角度
...
{
  // --------------------------------------
  // ======命令行参数Parse Command Line Arguments===============
  // --------------------------------------
  ...
  if (!pcd_filename_indices.empty ())//pcd file
  {
...
//========================= generate
  ...
  range_image.integrateFarRanges (far_ranges);//使用以下代码之后将它们并入到深度图像中。
